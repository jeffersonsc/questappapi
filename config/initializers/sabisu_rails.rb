...
SabisuRails.setup do |config|
  ...
  config.base_api_uri = 'api.questapp.dev'
  ...
  config.api_headers = { "Accept" => "application/vnd.questapp.v1" }
  #
  # config.api_headers = {}
  ...
  config.resources = ["landingpage"]
  #config.default_resource = :landingpage
